                            ...
                            <div class="search-field multi-select accordion-body px-0 pb-0">
                               <ul class="list list-inline mb-0 brand-list">
                                ...
                                <li class="list-item">
                                    ...
                                    <span class="text-right folat-end">
                ...
                <div class="d-flex justify-content-between mb-4 pb-md-2">
                    ...
                    <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
                        ...
                        <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0"
                            ...
                            <option value="-1" {{$order==-1 ? 'selected':''}}>預設</option>
                            ...
                            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <form method="POST" action="{{route('wishlist.item.remove',['rowId'=>Cart::instance('wishlist')->content()->where('id', $product->id)->first()->rowId])}}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="pc__btn-wl position-absolute top-0 end-0 bg-transparent border-0 js-add-wishlist " style="color: red" 
...
$(document).ready(function() {
    $('#pagesize').on("change", function() {
        ...
        console.log("Page size changed: " + $('#size').val());
        $('#frmfilter').submit();
    });

    $('#orderby').on("change", function() {
        $('#order').val($("#orderby option:selected").val());
        console.log("Order changed: " + $('#order').val());
        $('#frmfilter').submit();
    });
