        ...
        <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product.store')}}">
            ...
            <div class="wg-box">
                ...
                <fieldset class="name">
                    ...
                    <input class="mb-10" type="text" placeholder="Enter product slug" name="slug" tabindex="0" value="{{old('name')}}" aria-required="true" required="">
                    <div class="text-tiny">
                        輸入產品名稱時不要超過 100 個字元。</div>
                </fieldset>
                    ...
                    <div class="upload-image flex-grow">
                        ...
                        <div id="upload-file" class="item up-load">
                            <label class="uploadfile" for="myFile">
                                ...
                                <span class="body-text">將您的圖像拖放到此處或選擇<span class="tf-color">click to browse</span></span>
        ...
        <img src="images/upload/upload-1.png" alt="">
                        ...
                        <div id="galUpload" class="item up-load">
                            <label class="uploadfile" for="gFile">
                                ...
                                <span class="text-tiny">將您的圖像拖放到此處或選擇 <span
