            ...
            <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{route('admin.product.update')}}">
                ...
                <div class="wg-box">
                        ...
                        <div class="upload-image flex-grow">
                            ...
                            <div id="upload-file" class="item up-load">
                                <label class="uploadfile" for="myFile">
                                    ...
                                    <span class="body-text">將您的圖像拖放到此處或選擇<span class="tf-color">click to
                                            browse</span></span>
                        ...
                        <div class="upload-image mb-16">
                            ...
                            <div id="galUpload" class="item up-load">
                                <label class="uploadfile" for="gFile">
                                    ...
                                    <span class="text-tiny">將您的圖像拖放到此處或選擇 <span class="tf-color">click to
                                            browse</span></span>
                    ...
                    <div class="cols gap22">
                        ...
                        @enderror
                        <fieldset class="name">
                            <div class="body-title mb-10" {{ $product->brand_id == $brand->id ? 'selected' : '' }}>Featured
                            </div>
                            <div class="select mb-10">
                    ...
                    <div class="cols gap10">
                        <button class="tf-button w-full" type="submit">更新產品資料</button>
                    </div>
                </div>
            </form>
            <!-- /form-add-product -->
