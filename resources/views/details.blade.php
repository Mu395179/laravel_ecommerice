    ...
    <section class="product-single container">
      <div class="row">
        ...
        <div class="col-lg-5">
          ...
          <a href="{{route('cart.index')}}" class="btn btn-warning mb-3">前往購物車</a>
          @else
          <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
            ...
            <div class="product-single__addtocart">
              ...
              <input type="hidden" name="price" value="{{$product->sale_price == ''? $product->regular : $product->sale_price}}">
              <button type="submit" class="btn btn-primary btn-addtocart" data-aside="cartDrawer">加入購物車</button>
            </div>
          </form>
          @endif
            ...
            @foreach ($rproducts as $rproduct)
                <div class="swiper-slide product-card">
                    <div class="pc__img-wrapper">
                        ...
                        <a href="{{route('cart.index')}}" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium btn-warning mb-3">前往購物車</a>
                        @else
                        <form name="addtocart-form" method="post" action="{{route('cart.add')}}">
                            @csrf   
                            ...
                            <input type="hidden" name="price" value="{{$rproduct->sale_price == ''? $rproduct->regular : $rproduct->sale_price}}">                                 
                            <button type="submit" class="pc__atc btn anim_appear-bottom btn position-absolute border-0 text-uppercase fw-medium" data-aside="cartDrawer" title="Add To Cart">新增至購物車</button>
                        </form>
                        @endif
                    </div>
                    ...
                    <div class="pc__info position-relative">
                        <p class="pc__category">
                            {{ $rproduct->category ? $rproduct->category->name : 'Uncategorized' }}
                        </p>
                        <h6 class="pc__title">
